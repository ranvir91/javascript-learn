...
// let y = 20;
// Explanation: let and const are hoisted, but they are not initialized. Accessing them before the declaration results in a ReferenceError. This period between hoisting and declaration is called the Temporal Dead Zone (TDZ).
...
// myFunc(5);
// Explanation: Function arguments are treated as local variables and are initialized before the function body executes. The var a inside the function shadows the argument a after the assignment.
...
// outer();
// Explanation: In this case, there are two function declarations of the same name. The second declaration overrides the first due to hoisting.

// 8. Hoisting and Strict Mode:

// Strict mode doesn't change how hoisting works but can help catch errors related to accidental global variables, which are often related to misunderstanding hoisting.
